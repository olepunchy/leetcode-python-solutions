...
nums being 2. It does not matter what you leave beyond the returned k (hence they 
are underscores).
...
if __name__ == "__main__":
    ...
    numbers = [2, 3, 4, 5, 5, 9, 7]
    result = solution.remove_element(numbers, 5)

    print(f"result: {result}, list: {numbers}")

    numbers_two = [3, 2, 2, 3]
    result_two = solution.remove_element(numbers_two, 3)

    print(f"result: {result_two}, list: {numbers_two}")

    numbers_three = [5, 5, 5, 5, 5]
    result_three = solution.remove_element(numbers_three, 5)

    print(f"result: {result_three}, list: {numbers_three}")
